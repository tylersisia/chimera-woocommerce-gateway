<table class="striped" style="width:100%" cellspacing="0" cellpadding="5">
    <tr>
        <td>Exchange rate</td>
        <td>1 CMRA = <?php echo $details['rate_formatted'].' '.$details['currency']; ?></td>
    </tr>
    <tr>
        <td>Total amount</td>
        <td><?php echo $details['amount_total_formatted']; ?> CMRA</td>
    </tr>
    <tr>
        <td>Total paid</td>
        <td><?php echo $details['amount_paid_formatted']; ?> CMRA</td>
    </tr>
    <tr>
        <td>Total due</td>
        <td><?php echo $details['amount_due_formatted']; ?> CMRA</td>
    </tr>
    <tr>
        <td>Order age</td>
        <td><?php echo Chimera_Gateway::format_seconds_to_time($details['order_age']) ?> ago</td>
    </tr>
    <tr>
...
<table class="striped" style="width:100%" cellspacing="0" cellpadding="5">
    ...
    <tr>
        <td>
            <a href="http://blockapi.chimeraproject.io/?hash=<?php echo $tx['txid']; ?>#blockchain_transaction" target="_blank"><?php echo $tx['txid']; ?></a>
        </td>
        <td><?php echo $tx['height']; ?></td>
        <td><?php echo sprintf(CHIMERA_GATEWAY_ATOMIC_UNITS_SPRINTF, $tx['amount'] / CHIMERA_GATEWAY_ATOMIC_UNITS_POW); ?> CMRA</td>
    </tr>
    <?php endforeach; ?>
</table>
<?php endif; ?>
